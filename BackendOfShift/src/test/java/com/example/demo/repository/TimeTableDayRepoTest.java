...
class TimeTableDayRepoTest {
    ...
    void findAllOrderByIdAsc() {
        ...
        TimeTableStudent savedStudent = studentTimeTableRepo.save(timeTableStudent);
        ...
        TimeTableDay savedDays = timeTableDayRepo.save(timeTableDay);
        List<TimeTableDay> allOrderByIdAsc = timeTableDayRepo.findAllOrderByIdAsc();
        assertEquals(allOrderByIdAsc.get(allOrderByIdAsc.size()-1),savedDays);
    }
